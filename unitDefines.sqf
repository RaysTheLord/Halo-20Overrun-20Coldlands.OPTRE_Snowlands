...
if (_useCustom == 1) then {
	...
	private _templist = ["dev_flood_carrier_o","dev_flood_carrier_o","dev_flood_carrier_o","dev_flood_carrier_o","dev_flood_carrier_o","dev_flood_carrier_o","dev_flood_infection_o",
